// Created by Kyle Chang and Andre Corona
...
public class TicTacToeV1 {
	...
	//Creating a variable to count the number of turns.
	int turn = 1; 

	//9 boolean variables have been initialized to false and will be set to true once the player or computer has selected the corresponding button.
	...
	//Variables which will later be changed to reflect value in the box ('X' will be represented by 1, 'O' will be represented by 2) are initialized. 
	int b1, b2, b3, b4, b5, b6, b7, b8, b9 = 0;		

	//Variables initialized to be used to calculate the number of times a player has won in 2 player mode.
	int winCount1 = 0;
	int winCount2 = 0;

	//A variable called winnerfound has been initialized to detect if there has been a winner. Not used in 1 player, "Go First" mode.
	boolean winnerfound = false; 

	//The name of the textbox where player1 will insert his name.
	private JTextField Name1; 
	//The name of the textbox where player2 will insert his name.
	...
	private void initialize() {
		...
		//setting the font and size of the test.
			...
			public void actionPerformed(ActionEvent e) {
				...
				btnGoFirst.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						 ...
						 *
						 *The THIRD "if" statement is the most complicated. It can be broken down further into five parts. It appears in every button event except button 5. 
						 *PART 1 - If the human clicks the corresponding button and there has been more than 3 turns and the button hasn't been clicked, it is labeled as 'X'.
						 *Then, turn is incremented, assignments are made to the variable clickedX (where X is the button number) to true so it can't be clicked again, and bX (where X is the button number) to 1 to be used for the win code.
						 ...
						 *If one of these scenarios are met, the computer will make its move to win & lblYouLose will appear. If none of these scenarios are available, PART 3 runs.
						 ...
						 *PART 4 - The computer moves to an empty square. clicked5 is omitted because it'll always be occupied after the first two turns.
						...
						btn9.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent arg0) {
								...
								if (turn >= 3 && clicked9 == false){
									...
									else if (b5 == 1 && b9 == 1 && clicked3 == false){
										btn3.setLabel("O");  
										btn3.setForeground(Color.BLUE);
										btn3.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 99));
										turn++;
				...
				//what happens when btnGoSecond is clicked.
				btnGoSecond.addActionListener(new ActionListener() {

					@SuppressWarnings("deprecation")
					public void actionPerformed(ActionEvent e) {

						//btnGoFirst, btnGoSecond and lblWelcome are removed.
						frame.getContentPane().remove(btnGoFirst);
						frame.getContentPane().remove(btnGoSecond);
						frame.getContentPane().remove(lblWelcome);

						//the 9 buttons that form the Tic Tac Toe board are created and added on the screen.
						JButton btn1 = new JButton("");
						btn1.setBounds(56, 143, 141, 141);
						frame.getContentPane().add(btn1);
						...
						//When the computer goes first, it always goes in the middle (btn5). 
						btn5.setLabel("O");  
						btn5.setForeground(Color.BLUE);
						btn5.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 99));
						turn++;
						...
						/*The "Go Second" code can also be divided into three main "if" statements for each button except button 5.
						 *The human's moves are shown in a red 'X' and the computer's moves are shown in a blue 'O'.
						 * 
						 *The FIRST "if" statement runs when it is the human's turn and the corresponding button hasn't been clicked. 
						 *It labels the button with a red 'X', increments the turn, sets clickedX to true so it can't be clicked again and assigns the button a value of 1.
						 *There is one nested "if" statement and it determines where the computer goes after the human got his first turn (turn 3). It will go in either btn1 or btn3 (depends on scenario).
						 * 
						 *The SECOND "if" statement is the most complicated. It is very similar to the "Go First" code, but there are some subtle differences. It runs when it's the computer's turn (odd turn).
						 *PART 1 - The computer now checks if there is a way to win. The 24 different scenarios of being 1 click away from winning are checked.
						 *If one of these scenarios are met, the computer will make its move to win & lblYouLose will appear. Everything is assigned the same as "Go First" except winnerfound is also assigned to true. 
						 *If none of these scenarios are available, PART 2 runs.
						 *PART 2 - Checks to see if the player is about to win. 
						 *The 24 scenarios of where the human is one click away from winning is checked, and the computer clicks the button which blocks the human.
						 *If none of these scenarios are available, PART 3 runs.
						 *PART 3 - The computer moves to an empty square. clicked5 is omitted because it'll always be clicked first. 
						 *clicked9 is checked because the first 8 buttons may be occupied, but not the last, forcing the computer to go there since it went first.
						 *
						 *The THIRD "if" statement is the tie code. If it is the 10th turn (the board is full) and no winner has been found (winnerfound == false), the lbltie appears.
						 */
		...
		btn2Players.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//label prompts first user to enter his / her name
				...
				//label prompts second user to enter his / her name
				...
				//allows the users to input their names in textboxes called Name1 and Name2.
				...
				//A new button called "Let's GOOOOO!" is created, a font is added, and its location is set. It's added to the screen.
				...
				//What happens when the btnLetsGooooo is clicked
				btnLetsGooooo.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						//lblp1turn is created and added to the frame which indicates that it's player 1's turn
						...
						//lblp2turn is created, but not added to the frame which will indicate player 2's turn when appropriate.
						...
						//Creates a button called "Replay" that is added to the bottom of the screen.
						...
						//Created a button called "Menu" that is added to the bottom of the screen.
						...
						btnmenu.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent arg0) {
								...
								//Re-adds the buttons and label on the starting menu
								frame.getContentPane().add(lblWelcome);				
								frame.getContentPane().add(btn1Player);
								frame.getContentPane().add(btn2Players);
						...
						/*	
						 *  Each button has two main "if" statements.
						 ...
						 *  
						 *  The SECOND if statement runs if the turn number is 5 or greater and there hasn't been a winner yet. 
						 *  
						 ...
						 *  in a row/column/diagonal anywhere.  It does this by checking to see if all three of the buttons (i.e. b1, b2, b3 OR in any given row all have 
						 ...
						 *  game is won, you should not be able to keep playing. Also, because a winner is found, winnerfound is assigned to true.
						 *  
						 ...
						 *  (which uses the number 2).  If it is true, it adds lblPlayer2Wins. It also makes all the clicked_'s true, and winnerfound is true.
						 *  
